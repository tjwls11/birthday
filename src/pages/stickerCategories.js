import kitty1 from '../assets/icon/hellokitty/1.png'
import kitty2 from '../assets/icon/hellokitty/2.png'
...
export const STICKER_CATEGORIES = {
  hellokitty: {
    name: '헬로키티',
    stickers: [kitty1, kitty2, kitty3, kitty4],
  },
  Heartsping: {
    name: '하츄핑',
    stickers: [Heartsping1, Heartsping2],
  },
  writing: {
    name: '글씨',
